...
import type { User, UserCreatePayload, UserUpdatePayload } from '../model/user.types'

export type UsersListParams = ListParams

export async function fetchUsers(params: UsersListParams = {}): Promise<ApiResponse<User[]>> {
...
export async function createUser(payload: UserCreatePayload): Promise<ApiResponse<User>> {
