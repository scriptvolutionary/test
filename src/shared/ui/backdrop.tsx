...
export function PublicLayer() {
	return (
		<>
			...
			<div
				className={cn(
					'absolute top-1/7 left-1/2 size-200 -translate-x-1/2 rounded-full blur-5xl',
			...
			<Dot
				className='top-[26%] left-[18%] h-2 w-2'
			...
			/>
			<Dot
				className='top-[30%] right-[22%] h-1.5 w-1.5'
			...
			/>
			<Dot
				className='bottom-[18%] left-[28%] h-2 w-2'
				bg='rgb(from var(--foreground) r g b / 0.10)'
