...
const itemVariants = cva(
	"[a]:hover:bg-muted rounded-lg border text-sm w-full group/item focus-visible:border-ring focus-visible:ring-ring/50 flex items-center flex-wrap outline-none transition-colors duration-200 focus-visible:ring-[3px] [a]:transition-colors",
	{
		variants: {
			variant: {
...
function Item({
	...
	VariantProps<typeof itemVariants> & { test?: string }) {
	return useRender({
		defaultTagName: "div",
